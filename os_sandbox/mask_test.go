...
func TestGenerateSBPLProfile_MasksPaths(t *testing.T) {
	profile := generateSBPLProfile("/tmp/work", nil, credentialMasks{}, []string{"/var/run/docker.sock"}, sbplDenylist{})
...
func TestGenerateSBPLProfile_ExtraBinds(t *testing.T) {
	...
	profile := generateSBPLProfile("/tmp/work", []string{link}, credentialMasks{}, nil, sbplDenylist{})
